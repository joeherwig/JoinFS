...
- Every peer in a session, **and the hub / console you connect through**, must run 26.5.1 or newer. Mixing 26.5.1 with 26.5.0 or older can silently corrupt other aircraft's positions rather than fail cleanly - update everything together.
